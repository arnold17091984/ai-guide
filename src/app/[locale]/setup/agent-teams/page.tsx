...
const sectionColors: Record<string, string> = {
  ...
  control: "from-orange-500 to-amber-400",
  useCases: "from-pink-500 to-rose-400",
  bestPractices: "from-emerald-500 to-teal-400",
...
export default function AgentTeamsPage() {
  const t = useTranslations("setup.agentTeams");
